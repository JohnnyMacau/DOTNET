...
namespace DBUtil
{
    ...
    public static class DBHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        private static string m_ConnectionString = ConfigurationManager.ConnectionStrings["AdoDemo"].ToString();
        /// <summary>
        /// 事务
        /// </summary>
        [ThreadStatic]
        ...
        public static void Insert(object obj, bool autoIncrement)
        {
            ...
            strSql.Append("set identity_insert " + type.Name + " ON;");
            ...
            strSql.Append(" set identity_insert " +type.Name+" OFF;");
        ...
        /// 分页(任意entity，尽量少的字段)
        /// </summary>
        public static PagerModel FindDataSetBySql<T>(string sql, string orderby, int pageSize, int currentPage) where T : new()
        {
