<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewStudent.aspx.cs" Inherits="AdoDemo.Views.AddNewStudent" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="保存" OnClick="Button1_Click"  OnClientClick="return confirm('确定添加吗？')" />
